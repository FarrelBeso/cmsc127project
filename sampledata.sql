-- Insert users
INSERT INTO user (first_name, last_name, usertype, email, hashed_password) VALUES("John", "Lucas", "user", "johnlucas@gmail.com", "HASHEDPASSWORD");
INSERT INTO user (first_name, last_name, usertype, email, hashed_password) VALUES("Anna", "Smith", "user", "annasmith@gmail.com", "HASHEDPASSWORD");
INSERT INTO user (first_name, last_name, usertype, email, hashed_password) VALUES("admin", "admin", "admin", "admin@gmail.com", "HASHEDPASSWORD");
...
INSERT INTO review (rating, user_id, description, establishment_id) VALUES (4, 1, "yummy", 1);
INSERT INTO review (rating, user_id, description, establishment_id) VALUES (3, 2, "yummy", 1);
INSERT INTO review (rating, user_id, description, establishment_id) VALUES (2, 3, "yummy", 1);
...
-- Food Reviews
INSERT INTO review (rating, user_id, description, food_id) VALUES (4, 1, "yummy", 1);
